...
public class Idman1 {
    ...
    public int getSitap_sayisi() {
        return situp_sayisi;
    }

    public void setSitap_sayisi(int sitap_sayisi) {
        this.situp_sayisi = sitap_sayisi;
    }
    ...
    public Idman1(int burpee_sayisi, int pushup_sayisi, int sitap_sayisi, int squat_sayisi) {
        this.burpee_sayisi = burpee_sayisi;
        this.pushup_sayisi = pushup_sayisi;
        this.situp_sayisi = situp_sayisi; // burd hata veriyor anlamadim
        this.squat_sayisi = squat_sayisi;
    ...
    public void situpYap(int sayi) {
        ...
        if (situp_sayisi - sayi < 0) {
            System.out.println("Hedefledigin situp sayisina ulastin Tebrikler...");
            situp_sayisi = 0;
    ...
    public void squatYap(int sayi) {
        ...
        if (squat_sayisi - sayi < 0) {
            System.out.println("Hedefledigin squat sayisina ulastin tebrikler...");
            squat_sayisi = 0;
